        ...
        createUI: function () {
            for (var e = this, t = e.baseData(), a = e.config, n = t.domId, i = a.format.split(/-|\/|\s|:/g), o = i.length, r = "", s = e.$(a.el).bindDate || new Date, d = a.lang, l = 0; l < o; l++) {
                ...
                if (r += '<div id="' + n[c] + '"><ul>',
                    ...
                    for (var b = 0; b <= 59; b++)
                        r += '<li class="' + (b == s.getSeconds() ? "active" : "") + '">' + (b < 10 ? "0" + b : b) + d.sec + "</li>";
                r += "</ul></div>"
            }
            ...
            e.scroll.mm && 1 != a.minStep && w("#" + e.scroll.mm + " li").eq(Math.round(s.getMinutes() / a.minStep)).addClass("active"),
                w(".jdate-container ul").each(function () {
                    var e = w(this)
        ...
        slide: function (e) {
            ...
            function r(e) {
                ...
                e.css("top", Math.round(t / u) * u + "px"),
                    t = Math.round(Math.abs(w(e).position().top));
                var a = e.children("li").get(t / u);
                if (w(a).addClass("active").siblings().removeClass("active"),
